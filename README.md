...
# SaG4n - Simulation of (a,xn) reactions with Geant4
...
The users have to first download the library they want to use, uncompress it in any folder, and set the G4PARTICLEHPDATA environmental variable to the full path where is placed the (a,xn) data library. For example:
