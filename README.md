...
This release has been tested with Geant4.11.4.1, and is not expected to work with releases older than Geant4.11.3.0.
...
Some input examples are distributed together with the code. They are located inside the `inputs/examples` directory. Outputs generated with SaG4n using these inputs can be found in `outputs/examples_reference/`. They have been generated using Geant4.11.4.1 and the JENDLTENDL01 data library.
...
This work was supported in part by the ENRESA-CIEMAT agreement 2023-2026: “Tecnologías Disponibles para la Transmutación de Radionucleidos de Vida Larga”, by the Spanish Agencia Estatal de Investigación (AEI) / 10.13039/501100011033, under Grant PID2024-158174OB-I00 (Proyectos de Generación de Conocimiento 2024) and by the European Union’s HORIZON-EUROPE Research and Innovation Programme under grant agreement No. 101164596 (APRENDE, addressing priorities of evaluated nuclear data in Europe.) 
