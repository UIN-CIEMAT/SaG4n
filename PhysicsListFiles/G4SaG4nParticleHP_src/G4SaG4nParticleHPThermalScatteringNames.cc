...
G4SaG4nParticleHPThermalScatteringNames::G4SaG4nParticleHPThermalScatteringNames()
{
...
G4bool G4SaG4nParticleHPThermalScatteringNames::IsThisThermalElement( G4String aname)
{
   G4bool result = false;
...
G4bool G4SaG4nParticleHPThermalScatteringNames::IsThisThermalElement( G4String material , G4String element )
{
   G4bool result = false;
...
void G4SaG4nParticleHPThermalScatteringNames::AddThermalElement ( G4String nameG4Element , G4String filename)
{  
