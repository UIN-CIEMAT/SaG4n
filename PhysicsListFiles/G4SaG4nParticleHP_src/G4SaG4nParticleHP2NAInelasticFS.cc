...
G4SaG4nParticleHP2NAInelasticFS::G4SaG4nParticleHP2NAInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID( "model_G4SaG4nParticleHP2NAInelasticFS_F08" );
}
...
void G4SaG4nParticleHP2NAInelasticFS::
