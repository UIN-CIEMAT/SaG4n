...
G4SaG4nParticleHPFissionData::G4SaG4nParticleHPFissionData()
...
G4bool G4SaG4nParticleHPFissionData::IsIsoApplicable( const G4DynamicParticle* dp , 
                                                G4int /*Z*/ , G4int /*A*/ ,
                                                const G4Element* /*elm*/ ,
...
G4double G4SaG4nParticleHPFissionData::GetIsoCrossSection( const G4DynamicParticle* dp ,
                                   G4int /*Z*/ , G4int /*A*/ ,
                                   const G4Isotope* /*iso*/  ,
...
/*
G4bool G4SaG4nParticleHPFissionData::IsApplicable(const G4DynamicParticle*aP, const G4Element*)
{
  G4bool result = true;
...
void G4SaG4nParticleHPFissionData::BuildPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  

   if ( G4Threading::IsWorkerThread() ) {
      theCrossSections = G4SaG4nParticleHPManager::GetInstance()->GetFissionCrossSections();
      return;
   }
  ...
  for( size_t i=0; i<numberOfElements; ++i )
  {
   ...
   G4SaG4nParticleHPManager::GetInstance()->RegisterFissionCrossSections( theCrossSections );
}

void G4SaG4nParticleHPFissionData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");
...
//
  ...
  //G4cout << "G4SaG4nParticleHPFissionData::DumpPhysicsTable still to be implemented"<<G4endl;
  #endif
}

#include "G4NucleiProperties.hh"

G4double G4SaG4nParticleHPFissionData::
...
G4int G4SaG4nParticleHPFissionData::GetVerboseLevel() const 
{
   return G4SaG4nParticleHPManager::GetInstance()->GetVerboseLevel();
}
void G4SaG4nParticleHPFissionData::SetVerboseLevel( G4int newValue ) 
{
   G4SaG4nParticleHPManager::GetInstance()->SetVerboseLevel(newValue);
}
void G4SaG4nParticleHPFissionData::CrossSectionDescription(std::ostream& outFile) const
{
