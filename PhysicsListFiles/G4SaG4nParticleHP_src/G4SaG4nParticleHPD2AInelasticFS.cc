...
G4SaG4nParticleHPD2AInelasticFS::G4SaG4nParticleHPD2AInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID( "model_G4SaG4nParticleHPD2AInelasticFS_F32" );
}

G4HadFinalState * G4SaG4nParticleHPD2AInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{
...
void G4SaG4nParticleHPD2AInelasticFS::
