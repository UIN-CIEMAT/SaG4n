...
//
#include "G4SaG4nParticleHPJENDLHEData.hh"
...
G4bool G4SaG4nParticleHPJENDLHEData::IsApplicable(const G4DynamicParticle*aP, const G4Element* anE)
{
...
G4SaG4nParticleHPJENDLHEData::G4SaG4nParticleHPJENDLHEData()
{
...
G4SaG4nParticleHPJENDLHEData::G4SaG4nParticleHPJENDLHEData( G4String reaction , G4ParticleDefinition* pd )
...
void G4SaG4nParticleHPJENDLHEData::BuildPhysicsTable( const G4ParticleDefinition& aP )
{
...
void G4SaG4nParticleHPJENDLHEData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
//  G4cout << "G4SaG4nParticleHPJENDLHEData::DumpPhysicsTable still to be implemented"<<G4endl;
}



G4double G4SaG4nParticleHPJENDLHEData::
...
G4PhysicsVector* G4SaG4nParticleHPJENDLHEData::readAFile ( std::fstream* file )
{
...
G4bool G4SaG4nParticleHPJENDLHEData::isThisInMap( G4int z , G4int a )
{
...
void G4SaG4nParticleHPJENDLHEData::registAPhysicsVector( G4int Z , G4int A , G4PhysicsVector* aPhysVec )
{
...
G4double G4SaG4nParticleHPJENDLHEData::getXSfromThisIsotope( G4int Z , G4int A , G4double ek )
{
