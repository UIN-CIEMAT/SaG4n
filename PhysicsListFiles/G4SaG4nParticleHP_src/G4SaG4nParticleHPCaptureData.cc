...
G4bool G4SaG4nParticleHPCaptureData::IsIsoApplicable( const G4DynamicParticle* dp , 
                                                G4int /*Z*/ , G4int /*A*/ ,
                                                const G4Element* /*elm*/ ,
...
G4double G4SaG4nParticleHPCaptureData::GetIsoCrossSection( const G4DynamicParticle* dp ,
                                   G4int /*Z*/ , G4int /*A*/ ,
                                   const G4Isotope* /*iso*/  ,
...
/*
G4bool G4SaG4nParticleHPCaptureData::IsApplicable(const G4DynamicParticle*aP, const G4Element*)
{
  G4bool result = true;
...
void G4SaG4nParticleHPCaptureData::BuildPhysicsTable(const G4ParticleDefinition& aP)
{
  ...
  // G4cout << "CALLED G4SaG4nParticleHPCaptureData::BuildPhysicsTable "<<numberOfElements<<G4endl;
   // TKDB
  ...
  G4SaG4nParticleHPManager::GetInstance()->RegisterCaptureCrossSections( theCrossSections );
}
...
G4double G4SaG4nParticleHPCaptureData::
...
G4int G4SaG4nParticleHPCaptureData::GetVerboseLevel() const 
{
   return G4SaG4nParticleHPManager::GetInstance()->GetVerboseLevel();
}
void G4SaG4nParticleHPCaptureData::SetVerboseLevel( G4int newValue ) 
{
   G4SaG4nParticleHPManager::GetInstance()->SetVerboseLevel(newValue);
}
void G4SaG4nParticleHPCaptureData::CrossSectionDescription(std::ostream& outFile) const
{
