...
G4HadFinalState * G4SaG4nParticleHPNInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{

// do the final state
    G4SaG4nParticleHPInelasticCompFS::CompositeApply(theTrack, G4Neutron::Neutron());
