...
G4SaG4nParticleHPN3AInelasticFS::G4SaG4nParticleHPN3AInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID( "model_G4SaG4nParticleHPN3AInelasticFS_F07" );
}

G4HadFinalState * G4SaG4nParticleHPN3AInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{
...
void G4SaG4nParticleHPN3AInelasticFS::
