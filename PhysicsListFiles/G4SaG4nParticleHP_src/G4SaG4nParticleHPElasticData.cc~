...
G4bool G4SaG4nParticleHPElasticData::IsIsoApplicable( const G4DynamicParticle* dp , 
                                                G4int /*Z*/ , G4int /*A*/ ,
                                                const G4Element* /*elm*/ ,
...
G4double G4SaG4nParticleHPElasticData::GetIsoCrossSection( const G4DynamicParticle* dp ,
                                   G4int /*Z*/ , G4int /*A*/ ,
                                   const G4Isotope* /*iso*/  ,
...
/*
G4bool G4SaG4nParticleHPElasticData::IsApplicable(const G4DynamicParticle*aP, const G4Element*)
{
  G4bool result = true;
...
void G4SaG4nParticleHPElasticData::BuildPhysicsTable(const G4ParticleDefinition& aP)
{
...
// TKDB
  ...
  for( size_t i=0; i<numberOfElements; ++i )
  {
   ...
   G4SaG4nParticleHPManager::GetInstance()->RegisterElasticCrossSections(theCrossSections);
}

void G4SaG4nParticleHPElasticData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
...
G4double G4SaG4nParticleHPElasticData::
