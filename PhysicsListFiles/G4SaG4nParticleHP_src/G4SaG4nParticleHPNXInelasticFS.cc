...
G4SaG4nParticleHPNXInelasticFS::G4SaG4nParticleHPNXInelasticFS()
{
...
// fill the final state  
  G4SaG4nParticleHPInelasticBaseFS::BaseApply(theTrack, theDefs, 1);
  
// return the result
   return theResult.Get();
}

void G4SaG4nParticleHPNXInelasticFS::
