...
G4ReactionProduct * G4SaG4nParticleHPNBodyPhaseSpace::Sample(G4double anEnergy, G4double massCode, G4double )
{
   ...
   {
     throw G4HadronicException(__FILE__, __LINE__, "G4SaG4nParticleHPNBodyPhaseSpace: Unknown ion case 2");
   }
