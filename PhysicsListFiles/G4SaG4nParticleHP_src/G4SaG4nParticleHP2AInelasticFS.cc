...
G4SaG4nParticleHP2AInelasticFS::G4SaG4nParticleHP2AInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID( "model_G4SaG4nParticleHP2AInelasticFS_F28" );
}
...
void G4SaG4nParticleHP2AInelasticFS::
