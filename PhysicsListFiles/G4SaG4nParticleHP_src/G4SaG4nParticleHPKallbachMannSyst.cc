...
G4double G4SaG4nParticleHPKallbachMannSyst::Sample(G4double anEnergy)
{
  G4double result;
...
G4double G4SaG4nParticleHPKallbachMannSyst::Kallbach(G4double cosTh, G4double anEnergy)
{
...
G4double G4SaG4nParticleHPKallbachMannSyst::GetKallbachZero(G4double anEnergy)
{
  G4double result;
...
G4double G4SaG4nParticleHPKallbachMannSyst::A(G4double anEnergy)
{ 
  G4double result;
