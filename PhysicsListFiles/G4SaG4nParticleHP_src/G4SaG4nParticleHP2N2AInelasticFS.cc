...
G4SaG4nParticleHP2N2AInelasticFS::G4SaG4nParticleHP2N2AInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID( "model_G4SaG4nParticleHP2N2AInelasticFS_F12" );
}

G4HadFinalState * G4SaG4nParticleHP2N2AInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{
...
void G4SaG4nParticleHP2N2AInelasticFS::
