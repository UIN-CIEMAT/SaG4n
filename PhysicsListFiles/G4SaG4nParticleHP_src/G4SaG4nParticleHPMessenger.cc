...
G4SaG4nParticleHPMessenger::G4SaG4nParticleHPMessenger( G4SaG4nParticleHPManager* man )
:manager(man)
{
...
G4SaG4nParticleHPMessenger::~G4SaG4nParticleHPMessenger()
{
...
void G4SaG4nParticleHPMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
   G4bool bValue = false;
   ...
   if ( command == PhotoEvaCmd ) {
     if ( manager->GetUseOnlyPhotoEvaporation() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER UseOnlyPhotoEvaporation TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == SkipMissingCmd) {
     if ( manager->GetSkipMissingIsotopes() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER SkipMissingIsotopes TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == NeglectDopplerCmd ) {
     if ( manager->GetNeglectDoppler() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER NeglectDoppler TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == DoNotAdjustFSCmd ) {
     if ( manager->GetDoNotAdjustFinalState() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER DoNotAdjustFinalState TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == ProduceFissionFragementCmd ) { 
     if ( manager->GetProduceFissionFragments() != bValue ) {
      manager->SetProduceFissionFragments( bValue );
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER ProduceFissionFragments TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == WendtFissionModelCmd ) { 
     if ( manager->GetUseWendtFissionModel() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER UseWendtFissionModel TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == NRESP71Cmd ) { 
     if ( manager->GetUseNRESP71Model() != bValue ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER UseNRESP71Model TO "
	        << bValue << " ===" << G4endl;
       }
       if ( bValue ) {
   ...
   if ( command == VerboseCmd ) {
     ...
     if ( manager->GetVerboseLevel() != verboseLevel  ) {
       ...
       if ( G4HadronicParameters::Instance()->GetVerboseLevel() > 0 ) {
         G4cout << G4endl
	        << "=== G4SaG4nParticleHPMessenger CHANGED PARAMETER VerboseLevel TO "
	        << verboseLevel << " ===" << G4endl;
       }
       #endif
     }      
