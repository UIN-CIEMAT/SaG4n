...
G4SaG4nParticleHPN2AInelasticFS::G4SaG4nParticleHPN2AInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID( "model_G4SaG4nParticleHPN2AInelasticFS_F11" );
}
...
void G4SaG4nParticleHPN2AInelasticFS::
