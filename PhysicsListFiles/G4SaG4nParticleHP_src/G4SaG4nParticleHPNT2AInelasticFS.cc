...
G4SaG4nParticleHPNT2AInelasticFS::G4SaG4nParticleHPNT2AInelasticFS()
{
  secID = G4PhysicsModelCatalog::GetModelID( "model_G4SaG4nParticleHPNT2AInelasticFS_F17" );
}

G4HadFinalState * G4SaG4nParticleHPNT2AInelasticFS::ApplyYourself(const G4HadProjectile & theTrack)
{
...
void G4SaG4nParticleHPNT2AInelasticFS::
