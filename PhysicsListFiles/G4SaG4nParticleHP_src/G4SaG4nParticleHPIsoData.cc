...
#include "G4Neutron.hh"
  ...
  //G4bool G4SaG4nParticleHPIsoData::Init(G4int A, G4int Z, G4double abun, G4String dirName, G4String aFSType)
G4bool G4SaG4nParticleHPIsoData::Init(G4int A, G4int Z, G4int M, G4double abun, G4String dirName, G4String aFSType)
  {
    theChannelData = 0;
    G4double abundance = abun/100.;
    G4String filename;
    G4bool result = true;
    //G4SaG4nParticleHPDataUsed aFile = theNames.GetName(A, Z, dirName, aFSType, result);
    G4SaG4nParticleHPDataUsed aFile = theNames.GetName(A, Z, M, dirName, aFSType, result);
...
//    theChannel.close();
  ...
  //void G4SaG4nParticleHPIsoData::Init(G4int A, G4int Z, G4double abun) //fill PhysicsVector for this Isotope
#include "G4Proton.hh"
#include "G4Deuteron.hh"
#include "G4Triton.hh"
#include "G4He3.hh"
#include "G4Alpha.hh"
void G4SaG4nParticleHPIsoData::Init(G4int A, G4int Z, G4int M,G4double abun, G4ParticleDefinition* projectile, const char* dataDirVariable ) //fill PhysicsVector for this Isotope
  {
...
//  if(theFissionData!=0) theFissionData->Dump();
  ...
  G4String G4SaG4nParticleHPIsoData::GetName(G4int A, G4int Z, G4String base, G4String rest)
  {
    G4bool dbool;
