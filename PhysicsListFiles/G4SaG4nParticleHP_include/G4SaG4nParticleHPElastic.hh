...
//
#ifndef G4SaG4nParticleHPElastic_h
#define G4SaG4nParticleHPElastic_h 1
...
class G4SaG4nParticleHPElastic : public G4HadronicInteraction
{
  public: 
  ...
  private:
      std::vector<G4SaG4nParticleHPChannel*>* theElastic;
