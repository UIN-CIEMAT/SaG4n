...
//
#ifndef G4SaG4nParticleHPCaptureData_h
#define G4SaG4nParticleHPCaptureData_h 1
...
class G4SaG4nParticleHPCaptureData : public G4VCrossSectionDataSet
{
   public:
   
      G4SaG4nParticleHPCaptureData();
