...
public:
  ...
  ~G4SaG4nParticleHPChannel()
  {
    ...
    // ~G4SaG4nParticleHPIsoData.  FWJ 06-Jul-1999
  ...
  G4bool Register(G4SaG4nParticleHPFinalState *theFS);
  ...
  G4SaG4nParticleHPFinalState ** GetFinalStates() const {
...
private:
  ...
  G4SaG4nParticleHPVector * theChannelData;  // total (element) cross-section for this channel
  G4SaG4nParticleHPVector * theBuffer;
  
  G4SaG4nParticleHPIsoData * theIsotopeWiseData; // these are the isotope-wise cross-sections for each final state.
  G4SaG4nParticleHPFinalState ** theFinalStates; // also these are isotope-wise pionters, parallel to the above.
  G4bool * active;
  G4int niso;
