...
#ifndef G4SaG4nParticleHPKallbachMannSyst_h
#define G4SaG4nParticleHPKallbachMannSyst_h 1

#include "globals.hh"

class G4SaG4nParticleHPKallbachMannSyst
{
  public:
  
   G4SaG4nParticleHPKallbachMannSyst(G4double aCompoundFraction,
  ...
  ~G4SaG4nParticleHPKallbachMannSyst() {};
