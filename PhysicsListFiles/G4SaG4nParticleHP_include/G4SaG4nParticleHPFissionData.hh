...
//
#ifndef G4SaG4nParticleHPFissionData_h
#define G4SaG4nParticleHPFissionData_h 1
...
class G4SaG4nParticleHPFissionData : public G4VCrossSectionDataSet
{
   public:
   
      G4SaG4nParticleHPFissionData();
