...
//
#ifndef G4SaG4nParticleHPContAngularPar_h
#define G4SaG4nParticleHPContAngularPar_h 1
...
class G4SaG4nParticleHPContAngularPar
{
  ...
  G4SaG4nParticleHPContAngularPar()
  {
    theAngular = 0;
    //currentMeanEnergy = -2;
    //fresh = true;
  ...
  G4SaG4nParticleHPContAngularPar(G4ParticleDefinition* projectile); 
  ...
  void BuildByInterpolation(G4double anEnergy, G4InterpolationScheme aScheme, 
             G4SaG4nParticleHPContAngularPar & store1, 
             G4SaG4nParticleHPContAngularPar & store2);
    // NOTE: this interpolates legendre coefficients

  void PrepareTableInterpolation(const G4SaG4nParticleHPContAngularPar* angularPrev);
  ...
  G4double MeanEnergyOfThisInteraction()
  {
    ...
    {
      return 0;
      // throw G4HadronicException(__FILE__, __LINE__, "G4SaG4nParticleHPContAngularPar: Logical error in Product class");
    }
    else
    {
  ...
  G4SaG4nParticleHPList* GetAngDataList() const
  {
    return theAngular; 
  }
...
private:
  ...
  G4SaG4nParticleHPList * theAngular; 
