...
// ********************************************************************
//
#ifndef G4SaG4nParticleHPMessenger_h
#define G4SaG4nParticleHPMessenger_h
...
class G4SaG4nParticleHPMessenger: public G4UImessenger
{
   public:
      G4SaG4nParticleHPMessenger( G4SaG4nParticleHPManager* );
     ~G4SaG4nParticleHPMessenger();

      void SetNewValue(G4UIcommand*, G4String);

   private:
      G4SaG4nParticleHPManager* manager;
