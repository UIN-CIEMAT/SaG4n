...
//
#ifndef G4SaG4nParticleHPInelasticData_h
#define G4SaG4nParticleHPInelasticData_h 1
...
class G4SaG4nParticleHPInelasticData : public G4VCrossSectionDataSet
{
   public:
   
      G4SaG4nParticleHPInelasticData(G4ParticleDefinition* projectile = G4Neutron::Neutron());
   
      ~G4SaG4nParticleHPInelasticData();
  ...
  //void BuildPhysicsTableHP(G4ParticleDefinition* projectile, const char* dataDirVariable); // name it 'HP' to avoid compilation warning because of G4VCrossSectionDataSet's method
   ...
   private:
      ...
      G4SaG4nParticleHPData* theHPData;
