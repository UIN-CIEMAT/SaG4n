...
//
#ifndef G4SaG4nParticleHPFinalState_h
#define G4SaG4nParticleHPFinalState_h
...
class G4SaG4nParticleHPFinalState
{
public:

  G4SaG4nParticleHPFinalState()
  { 
    hasFSData = true; 
    hasXsec = true;
    hasAnyData = true;
  ...
  // this would better be done templating G4SaG4nParticleHPChannel..., 
  // 
  ...
  virtual G4SaG4nParticleHPVector * GetXsec() { return 0; }
  ...
  void SetAZMs(G4double anA, G4double aZ, G4int aM, G4SaG4nParticleHPDataUsed used) 
  {
